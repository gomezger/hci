jQuery("#simulation")
  .on("click", ".s-11ebeee7-fea8-4ca8-b4b2-5678786a2496 .click", function(event, data) {
    ...
    if(jFirer.is("#s-Triangle")) {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Two-line-item_14")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Two-line-item_15")) {
      cases = [
        {
          "blocks": [
            {
